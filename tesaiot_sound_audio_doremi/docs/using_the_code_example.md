...
The following example clones the "[I2S](https://github.com/Infineon/mtb-example-psoc-edge-i2s)" application with the desired name "I2S" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-i2s --user-app-name I2S --target-dir "C:/mtb_projects"
   ```
